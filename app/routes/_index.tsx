...
export default function Index() {
    ...
    const sidebarChildContainerRefs = useRef<{
                ...
                const sortable = Sortable.create(container, {
                    ...
                    onEnd: (evt) => {
                        if (
                            ...
                            const fromParentIndex = parseInt(
                                evt.from.dataset.parentIndex || "0"
                            );
                            const toParentIndex = parseInt(
                                evt.to.dataset.parentIndex || "0"
                            );
                            ...
                            if (fromParentIndex === toParentIndex) {
                                ...
                                const [movedChild] = childArray.splice(
                                    evt.oldIndex,
                                    1
                                );
                                ...
                                const toChildArray = [
                                    ...newParentArray[toParentIndex].childArray,
                                ];

                                const [movedChild] = fromChildArray.splice(
                                    evt.oldIndex,
                                    1
                                );
                                toChildArray.splice(
                ...
                const sortable = Sortable.create(container, {
                    ...
                    onEnd: (evt) => {
                        if (
                            ...
                            const fromParentIndex = parseInt(
                                evt.from.dataset.sidebarParentIndex || "0"
                            );
                            const toParentIndex = parseInt(
                                evt.to.dataset.sidebarParentIndex || "0"
                            );
                        ...
                        {parentFields.map((parentField, parentIndex) => (
                            <div key={parentField.id} className="parent-item">
                                <div className="parent-header">
                                    <span className="drag-handle parent-drag-handle">
                                        ⋮⋮
                                    </span>
                                    <input
                                        {...register(
                                            `parentArray.${parentIndex}.parentKey`
                                        )}
                                    ...
                                    >
                                        {watchedData.parentArray[
                                            ...
                                            (
                                                ...
                                                <div
                                                    key={`form-child-${parentIndex}-${child.childKey}`}
                        ...
                        (parent: Parent, parentIndex: number) => (
                            <li key={parentIndex} className="index-item">
                                ...
                                <div
                                    ...
                                    ref={(el) => {
                                        sidebarChildContainerRefs.current[
                                            parentIndex
                                        ] = el;
                                    }}
                                ...
                                >
                                    {parent.childArray.map(
                                        (child: Child, childIndex: number) => (
                                            ...
                                            >
                                                <span className="drag-handle sidebar-child-drag-handle">
                                                    ⋮
                                                </span>
                                                <span>
